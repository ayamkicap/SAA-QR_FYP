...
const EditUserForm = ({ user }) => {
  ...
  const [yearStudy, setYearStudy] = useState(user.year_study);
  ...
  const onSaveUserClicked = async (e) => {
    if (password) {
        await updateUser({ id: user.id, username, email, password, card_number: cardNumber, year_study: yearStudy, roles, active })
    } else {
        await updateUser({ id: user.id, username, email, card_number: cardNumber, year_study: yearStudy, roles, active })
    }
  };
