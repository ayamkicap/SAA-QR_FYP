...
const EditUserForm = ({ user }) => {
    ...
    const onSaveUserClicked = async (e) => {
        if (password) {
            await updateUser({ id: user.id, username, email, password, roles, active, card_number: cardNumber, year_study: yearStudy })
        } else {
            await updateUser({ id: user.id, username, email, roles, active, card_number: cardNumber, year_study: yearStudy })
        }
    }
